...
1. Start with [Core Concept](/protocol/concept/) for the protocol framing.
2. Continue to [Roles: Publishers and Consumers](/protocol/roles/) and [Visible Identity Set](/protocol/horizon-rules/).
3. Read [Whitepaper V5](/whitepapers/v5/) for the full argument.
