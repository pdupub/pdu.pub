...
1. 笔记稿中关于「物理学」的所有举例，只是为方便说明问题，不必深究。
...
> 关于速度变化的速度受限于事件发生附带有成本的想法后期有所改变，现在更倾向于速度变化的限制仅仅来自于我们本身智能对于真实世界感受的限制。

> 在构建pdu时也存在简化可能，如经典物理对于世界的简化。
...
> 以超越光速的速度远离我们的物体，也不会突然从我们的世界中消失，也是一个逐渐的过程。

> 生命就是像是整个宇宙在尺寸维度塌陷过程中的不均匀所产生的涟漪，虽然最终一切都会归于热寂，但存在对抗这种大趋势的不甘。
...
更通俗的说你就是”你做的所有事“。即与你的出生，长大相关联的事件的总和。你是从你出生至今发生的于“你”相关的事件合集。
...
> 最初我将系统分为「封闭系统」和「开放系统」，封闭系统无对外的交互，系统内部不可知系统外部，同样系统外部也不可知系统内部。但后来发现这种分类并不合适，可能只存在一个封闭的系统，即我们存在的系统的整体，而我原来认为的一些封闭系统，多是由于「尺寸维度」造成的，并非真正的内外隔离，所以后来慢慢很少在谈及相关概念。
...
但其实即便不存在不确定，也不等于未来式可以被预知，被计算的。因为在系统中的部分所进行的任何行为已经是必然的一部分，计算的结果也是必然的一部分。无论计算结果，还是真实未来都是必然的一部分，是两个东西。
...
> 如第一节中注视所说，现在我更强相遇变化改变的压制力量并非来自时间，而是源自于我们作为智能的感受能力。

> 随机的来源是更小的尺寸维度的必然，他们有那个尺寸维度下规则的因果，是可归因的。但我们的维度中并不可知他们的归因过程。而且这种看似随机的现象也是对于我们对世界认知的简化。
