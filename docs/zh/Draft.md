...
1. 视界：每个个体的视界不要求一致，定义应是当前个体可见的全部。
2. 个体：等同于个体意识，简称为个体。
3. 个体集合：个体可同时属于多个个体集合，源自于个体意识对于自身的多种身份认同。「类似阿德勒所说的共同体感觉。」
...
「相对于星体来说，他的空间尺寸对应的时间维度与一个微观粒子的时间维度是不同的。可以这样理解，以人类的时间描述，微观粒子的一秒和星体的一一年，对于粒子本身和对于星体本身来说会体验到同样的时间。」

「古语说天上一天，地下一年，位置的不同产生时间的不同。相对论说，不同的速度，观测到不同的时间流速。这里认为，对于不同空间尺寸来说，其本身的时间是不同的，这里的时间是其主体对于变化的感受。」
